...
SUBROUTINE DABuncertainty(MWsolvent,rhoSatSolventNBP, MWsolute,rhoSoluteAtSolventTsatNBP, &
						...
						U_T, U_MW_relative, U_sigma_relative )
	IMPLICIT NONE
	...
	REAL :: Va, Vb, U_Pv_sq, U_ToT_sq, U_Arho_sq, U_Brho_sq, T, U_rhoAOrhoA_sq, &
			...
			U_sigmaBosigmaB_sq, U_DabODab_sq, U_Dab, U_Dab_95, U_Crho_sq, U_nrho_sq
	...
	WRITE(*,10) SQRT(U_ToT_sq)*100
	10 FORMAT("U_ToT.....................", ES14.6, " %")
	...
	WRITE(*,20) SQRT(U_rhoAOrhoA_sq)*100		! (U_rho_A/ rho_A)
	20 FORMAT("U_rhoAOrhoA...............", ES14.6, " %")
	...
	WRITE(*,40) SQRT(U_rhoBOrhoB_sq)*100			! (U_rho_B/ rho_B)^2
	40 FORMAT("U_rhoBOrhoB...............", ES14.6, " %")
	...
	WRITE(*,30) SQRT(U_VaOVa_sq)*100				! (U_{V_A}/V_A)^2
	30 FORMAT("U_VaOVa...................", ES14.6, " %")
	...
	WRITE(*,50) SQRT(U_VbOVb_sq)*100				! (U_{V_B}/V_B)^2
	50 FORMAT("U_VbOVb...................", ES14.6, " %")
	...
	WRITE(*,60) SQRT(U_etaBOetaB_sq)*100 			! (U_{V_B}/V_B)^2
	60 FORMAT("U_etaBOetaB...............", ES14.6," %")
	...
	WRITE(*,70) SQRT(U_DabODab_sq)*100 						
	70 FORMAT("U_DabODab.................", ES14.6," %")
