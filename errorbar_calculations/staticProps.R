...
staticProps <- function( sol_id ){
	...
	if (sol_id == 2){
		...
		mu_Ao <- 1053.2e-3  # static viscosity of Glycerol (N-s/m^2) at 1 atm, 298 K
		rho_Ao <- 1257.575 	# density of Glycerol (kg/m^3) at 1 atm, 298 K

		# Define solvent (Propanol) static viscosity and density
		# Vargaftik tabulated values
		mu_Bo <- 1.9672e-3  # static viscosity of Propanol at 1 atm, 298K (kg/m^3)
		rho_Bo <- 0.8e3 	# density of Propanol at 1 atm, 298 K (kg/m^3)
